...
let awakePlane = 2;//動く方
let withinRange = 1;
let calPlaneAwake = false;
...
export class Canvas {
  constructor() {
    ...
    pane.on('change', (val) => {
      ...
      // water.opacity = PARAMS.waterAlpha;
    });
    ...
    var positionKeyframeTrackJSON = {
      ...
      type: "vector",
      times: [0, 1, 2],
      values: [firstPosition.x, 0, firstPosition.z, firstPosition.x + 50, 1, firstPosition.z + 70, firstPosition.x, 0, firstPosition.z]
    }
